...
namespace andywiecko.BurstTriangulator.Editor.Tests
{
    ...
    public static class TestExtensions
    {
        ...
        public static void ConstrainEdge<T>(this UnsafeTriangulator<T> triangulator, NativeOutputData<T> output, int pi, int pj, Allocator allocator, bool ignoreForPlantingSeeds = false, int sloanMaxIters = 1_000_000, bool verbose = true) where T : unmanaged => LowLevel.Unsafe.Extensions.ConstrainEdge((dynamic)triangulator, (dynamic)output, pi, pj, allocator, ignoreForPlantingSeeds, sloanMaxIters, verbose);
        public static void PlantHoleSeeds<T>(this UnsafeTriangulator<T> triangulator, NativeOutputData<T> output, Allocator allocator, bool autoHolesAndBoundary = false, bool restoreBoundary = false, NativeArray<T> holeSeeds = default, NativeList<int> mapping = default) where T : unmanaged => LowLevel.Unsafe.Extensions.PlantHoleSeeds((dynamic)triangulator, (dynamic)output, allocator, autoHolesAndBoundary, restoreBoundary, (dynamic)holeSeeds, mapping);
